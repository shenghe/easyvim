...
if has("toolbar")
    ...
    tmenu ToolBar.New                                           New
    tmenu ToolBar.Open                                          Open
    tmenu ToolBar.Save                                          Save
    tmenu ToolBar.Undo                                          Undo
    tmenu ToolBar.Redo                                          Redo
    tmenu ToolBar.Cut                                           Cut
    tmenu ToolBar.Copy                                          Copy
    tmenu ToolBar.Paste                                         Paste
    tmenu ToolBar.Replace                                       Search
    tmenu ToolBar.FindNext                                      Next
    tmenu ToolBar.FindPrev                                      Pre
    tmenu ToolBar.RunScript                                     Make
    tmenu ToolBar.Shell                                         Online
