...
nmake -f Make_mvc.mak GUI=yes PYTHON=C:\Python27 DYNAMIC_PYTHON=no PYTHON_VER=27 PYTHON3=C:\Python32 DYNAMIC_PYTHON3=yes PYTHON3_VER=32 OLE=yes IME=yes GIME=yes DYNAMIC_IME=yes GDYAMIC_IME=yes MULTI_BYTE=yes MULTI_BYTE_IME=yes USERNAME=sheng.he.china USERDOMAIN=gmail.com DEFINES=-DFEAT_PROPORTIONAL_FONTS FEATURES=HUGE
nmake -f Make_mvc.mak clean
nmake -f Make_mvc.mak PYTHON=C:\Python27 DYNAMIC_PYTHON=no PYTHON_VER=27 PYTHON3=C:\Python32 DYNAMIC_PYTHON3=yes PYTHON3_VER=32 OLE=yes IME=yes GIME=yes DYNAMIC_IME=yes GDYAMIC_IME=yes MULTI_BYTE=yes MULTI_BYTE_IME=yes USERNAME=sheng.he.china USERDOMAIN=gmail.com DEFINES=-DFEAT_PROPORTIONAL_FONTS FEATURES=HUGE
