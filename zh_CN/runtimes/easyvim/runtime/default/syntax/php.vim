...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  hi phpStringSingle term=underline  cterm=bold ctermfg=magenta guifg=#008000 guibg=#FEFCF5
  HiLink   phpStringDouble  phpStringSingle
  HiLink   phpBacktick  phpStringSingle
  HiLink   phpNumber  Number
  HiLink   phpFloat Float
  hi   phpMethods term=underline ctermfg=brown  gui=bold guifg=#804000
  HiLink   phpFunctions phpMethods
  HiLink   phpBaselib phpMethods
  HiLink   phpSpecialFunction  phpMethods
  hi   phpRepeat  term=bold  cterm=bold ctermfg=yellow gui=bold  guifg=#0000FF
  HiLink   phpConditional phpRepeat
  HiLink   phpLabel phpRepeat
  HiLink   phpStatement phpRepeat
  HiLink   phpKeyword phpRepeat
  HiLink   phpType  Type
  HiLink   phpInclude Include
  HiLink   phpDefine  Define
  HiLink   phpSpecialChar SpecialChar
  hi   phpParent  term=bold  cterm=bold ctermfg=red  guifg=#000000
  HiLink   phpIdentifierConst phpParent
  HiLink   phpOperator  phpParent
  HiLink   phpMemberSelector  phpParent
  HiLink   phpRelation  phpParent
  HiLink   phpParentError Error
  HiLink   phpOctalError  Error
  HiLink   phpTodo  Todo
  hi phpVarSelector gui=italic guifg=#000080 ctermfg=DarkGreen
  HiLink phpIdentifier  phpVarSelector
  HiLink phpIdentifierSimply  phpVarSelector
  HiLink  phpIntVar phpVarSelector
  HiLink  phpEnvVar phpVarSelector
  delcommand HiLink
endif
