...
if has("toolbar")
    ...
    tmenu ToolBar.New                                           新增文件
    tmenu ToolBar.Open                                          打開文件
    tmenu ToolBar.Save                                          存儲文件
    tmenu ToolBar.Undo                                          取消操作
    tmenu ToolBar.Redo                                          重做操作
    tmenu ToolBar.Cut                                           剪下
    tmenu ToolBar.Copy                                          複制
    tmenu ToolBar.Paste                                         貼上
    tmenu ToolBar.Replace                                       搜尋
    tmenu ToolBar.FindNext                                      搜尋下一個
    tmenu ToolBar.FindPrev                                      搜尋上一個
    tmenu ToolBar.RunScript                                     編譯文件
    tmenu ToolBar.Shell                                         在線預覽
    tmenu ToolBar.Help                                          搜尋幫助
endif
"}}}
