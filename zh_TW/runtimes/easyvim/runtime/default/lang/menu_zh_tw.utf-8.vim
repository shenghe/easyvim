...
" Maintainer : SHENG-PC(sheng.he.china@gmail.com)
" File : menu_zh_tw.utf-8.vim
" Date : 2012/2/26 上午 11:40:20
...
"--View---
menutrans &View                                         檢視(&V)
menutrans FileExplore                                   檔案管理器
menutrans Toggle\ FileExplore                           開關檔案管理器
menutrans Toggle\ MarksTree                             開關檔案記錄視窗
...
menutrans Add\ Bookmark                                 添加書籤
menutrans Delete\ Bookmark                              刪除書籤
menutrans Search\ Bookmark                              搜尋書籤
menutrans Toggle\ Bookmark                              開關書籤列表
menutrans Other\ Windows                                更多視窗
menutrans Toggle\ Buffer                                開關Buffer視窗
menutrans Toggle\ Mark                                  開關標簽視窗
menutrans Toggle\ Tag                                   開關Tags視窗
menutrans Toggle\ Sign                                  切換標誌
...
menutrans Tags\ and\ Cscope                             Tags相關設置
menutrans Make\ Cscope\ Datebase                        創建Cscope數據庫
menutrans Find\ This\ C\ Symbol                         查找本C符號
menutrans Find\ This\ Function\ Definition              查找本定義
menutrans Find\ Functions\ Called\ By\ This\ Function   查找調用本函數的函數
menutrans Find\ Functions\ Calling\ this\ Function      查找本函數調用的函數
...
menutrans   Tocn                                        繁轉簡
menutrans   Totw                                        簡轉繁
menutrans Export\ And\ Import                           導入與導出
menutrans Import\ Vimscript                             導入腳本
menutrans Import\ The\ View                             導入視圖
menutrans Export\ The\ View                             導出視圖
menutrans Export\ The\ Settings                         導出設置
menutrans Export\ To\ Html                              導出為Html
" The popup menu
